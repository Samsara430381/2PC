...
// 5    8     11    14
int dim = 1ULL << 14;   
// Assertion 'bw_y - s_y + 2 * bw_tmp_s <= 64' (s_tmp = s_x + ADD_PRECISION)
// int bw_x = 16;
// int bw_y = 14;
// int s_x = 12;
// int s_y = 12;    // s_y = 12: s_tmp 24(1 ulp)   s_tmp 22(2 ulp)   s_tmp 20(10 ulp);  s_y = 9: s_tmp 20(2 ulp)
int bw_x = 20;
int bw_y = 18;
int s_x = 16;
int s_y = 16;          // bw_tmp_s 24(45 ulp) bw_tmp_s 26(8 ulp) bw_tmp_s 28(3 ulp) bw_tmp_s 29 (2 ulp)
...
void exp_thread(int tid, uint64_t *x, uint64_t *y, int num_exp)
{
  ...
  math->secExp_N2(num_exp, x, y, bw_x, bw_y, s_x, s_y);
  delete math;
}
